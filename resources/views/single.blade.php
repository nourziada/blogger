                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="blog-details-author">
                            ...
                            <div class="blog-details-author-thumb">
                                <img style="border-radius: 50%" src="{{$post->user->profile->avatar}}" alt="Author">
                            </div>
                        ...
                        <div class="pagination-arrow">
                            ...
                            @if($next_post)
                                <a href="/post/{{$next_post->slug}}" class="btn-next-wrap">
                            ...
                            @if($prev_post)
                                <a href="/post/{{$prev_post->slug}}" class="btn-prev-wrap">
                                    <svg class="btn-prev">
